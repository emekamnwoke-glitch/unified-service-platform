...
- **38-53% cost reduction** (illustrative model, wider under currency depreciation) through eliminating FX-exposed licensing
...
3. **Key metrics:** 10x scalability, 38-53% cost reduction (illustrative model, SDD §8), compliance achievement, microservices decomposition
...
| **Cost Reduction** | 38-53% vs. vendor, FX-scenario dependent | ✓ Modeled in SDD §8 |
